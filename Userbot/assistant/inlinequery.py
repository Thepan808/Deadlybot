    ...
    if query.startswith("#pmpermit"):
        ...
        results=[
            InlineQueryResultPhoto(
                ...
                title="ᴛʀᴏɴ ɪɴʟɪɴᴇ sᴇᴄᴜʀɪᴛʏ sʏsᴛᴇᴍ",
                description="ᴅᴇᴀᴅʟʏ sᴇᴄᴜʀɪᴛʏ sʏsᴛᴇᴍ ɪɴʟɪɴᴇ ᴍᴇɴᴜ.",
                caption=app.PmpermitText(),
                parse_mode=ParseMode.DEFAULT,
                reply_markup=InlineKeyboardMarkup(
                    [
                        app.BuildKeyboard(([["๏ Aᴘᴘʀᴏᴠᴇ ๏", "approve-tab"]]))
                    ]
                )
            )
        ],
        ...
        results=[
            InlineQueryResultPhoto(
                ...
                title="ᴛʀᴏɴ ɪɴʟɪɴᴇ ʜᴇʟᴘᴅᴇx ᴍᴇɴᴜ",
                description="ɢᴇᴛ ʏᴏᴜʀ ɪɴʟɪɴᴇ ʜᴇʟᴘᴅᴇx ᴍᴇɴᴜ.",
